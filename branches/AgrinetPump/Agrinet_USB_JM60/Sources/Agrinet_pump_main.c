...
N_tabella=0,//0=trifase 5.5KW, 1=trifase 2.2KW, 2=monofase 2.2KW, 3=monofase 1KW
...
2,    //limite_intervento_squilibrio %
...
if(toggle_func)//lettura e modifica delle funzioni
 ...
 if(toggle_stop==0)//modifica della funzione
  ...
  if(salita_meno)
   {
   salita_meno=0;
   if(cursore_menu<39) cursore_menu++; else if(numero_ingresso==chiave_ingresso) cursore_menu=1; else cursore_menu=0;
   if(numero_ingresso==chiave_numero_serie)
    {
    if(cursore_menu==39) cursore_menu=35;
    } 
   else// if(numero_ingresso!=chiave_numero_serie)
    {
    if(cursore_menu==35) if(numero_ingresso==chiave_ingresso) cursore_menu=1; else cursore_menu=0; //non presenta le tarature
    if(cursore_menu==37) if(numero_ingresso==chiave_ingresso) cursore_menu=1; else cursore_menu=0; //non presenta le tarature
    if(cursore_menu==38) if(numero_ingresso==chiave_ingresso) cursore_menu=1; else cursore_menu=0; //non presenta le tarature
    if(cursore_menu==39) if(numero_ingresso==chiave_ingresso) cursore_menu=1; else cursore_menu=0; //non presenta le tarature
    }
   if(set.monofase_trifase==0)
    {
    if(cursore_menu==7) cursore_menu++; //solo trifase
   ...
   if(numero_ingresso==chiave_numero_serie)
    ...
    {
    if(cursore_menu==39) cursore_menu--; //non presenta le tarature
    if(cursore_menu==38) cursore_menu--; //non presenta le tarature
    if(cursore_menu==37) cursore_menu--; //non presenta le tarature
    if(cursore_menu==35) cursore_menu--; //non presenta le tarature
    }
   if(set.monofase_trifase==0)
    {
    if(cursore_menu==12) cursore_menu--; //solo trifase
  ...
  switch(cursore_menu)
   ...
   case 17:
    {
    if(set.abilita_sensore_pressione) presenta_scritta((char*)&lettura_allarmi,2,0,24,1,0,16);
    else presenta_scritta((char*)&lettura_allarmi,1,0,24,1,0,16);
    } break;
   ...
   case 35: presenta_scritta((char*)&comando_reset,1,0,1,1,0,16); break;
   case 36: presenta_unsigned(set.numero_serie,0,1,7,5); break;
   case 37: presenta_unsigned(set.calibrazione_I1,0,0,12,3); break;
   case 38: presenta_unsigned(set.calibrazione_I2,0,0,12,3); break;
   case 39: presenta_unsigned(set.calibrazione_I3,0,0,12,3); break;
   }
  }
 ...
 else if(cursore_menu==36) //numero serie
  {
   ...
   case 34:
    ...
    if(pronto_alla_risposta)
     ...
     if(buffer_USB[0]<29)
      ...
      presenta_scritta((unsigned char *)&lettura_allarmi,0,(char)set.lingua,24,0,0,16);
...
switch(indentificazione)
 ...
 case 0:
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,1,(char)set.lingua,24,1,0,16);
  } break; 
 case 1:
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,2,(char)set.lingua,24,1,0,16);
  } break; 
 case 10://I2xT
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,3,(char)set.lingua,24,1,0,16);
  } break;
 case 11://sovratensione
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,4,(char)set.lingua,24,1,0,16);
  } break;
 case 12://sottotensione
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,5,(char)set.lingua,24,1,0,16);
  } break;
 case 13://mandata chiusa
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,6,(char)set.lingua,24,1,0,16);
  } break;
 case 14://funzionamento a secco
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,7,(char)set.lingua,24,1,0,16);
  } break;
 case 15://sovratemperatura motore
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,8,(char)set.lingua,24,1,0,16);
  } break;
 case 16://protezione differenziale
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,9,(char)set.lingua,24,1,0,16);
  } break;
 case 17://squilibrio correnti
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,10,(char)set.lingua,24,1,0,16);
  } break;
 case 18://dissimmetria tensioni
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,11,(char)set.lingua,24,1,0,16);
  } break;
 case 19://Pressione emergenza  
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,12,(char)set.lingua,24,1,0,16);
  } break;
 case 20://I2xT
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,13,(char)set.lingua,24,1,0,16);
  } break;
 case 21://sovratensione
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,14,(char)set.lingua,24,1,0,16);
  } break;
 case 22://sottotensione
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,15,(char)set.lingua,24,1,0,16);
  } break;
 case 23://mandata chiusa
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,16,(char)set.lingua,24,1,0,16);
  } break;
 case 24://funzionamento a secco
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,17,(char)set.lingua,24,1,0,16);
  } break;
 case 25://sovratemperatura motore
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,18,(char)set.lingua,24,1,0,16);
  } break;
 case 26://protezione differenziale
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,19,(char)set.lingua,24,1,0,16);
  } break;
 case 27://squilibrio correnti
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,20,(char)set.lingua,24,1,0,16);
  } break;
 case 28://dissimmetria tensioni
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,21,(char)set.lingua,24,1,0,16);
  } break;
 case 29://sensore pressione      
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,22,(char)set.lingua,24,1,0,16);
  } break;
 case 30://pressione emergenza    
  {
  presenta_scritta((unsigned char *)&lettura_allarmi,23,(char)set.lingua,24,1,0,16);
  } break;
 }
} 
  ...
  if(relais_alimentazione==0)
   ...
   if(timer_riavviamento==0)
    ...
    &&(remoto==filtro_pulsanti))
     {
     if((set.abilita_sensore_pressione==0)||(set.modo_start_stop==0)||
...
if(relais_alimentazione) //alimentazione presente
 ...
 if((set.abilita_sensore_pressione)&&(pressione<emergenza_sensore_pressione)) //allarme sensore
 ...
 else if((set.abilita_sensore_pressione)&&(pressione>set.pressione_emergenza))
  {
  relais_alimentazione=0;
  segnalazione_=30;
  timer_riavviamento=timer_ritorno_da_emergenza;
  }
 else if(Id_rms>set.limite_corrente_differenziale)
  {
 ...
 else //pressione_emergenza
  {
  timer_attesa_differenziale=timer_ritorno_da_emergenza;
  if(tensione_media<sottotensione_consentita)
   {
  ...
  else if(tensione_media>sovratensione_consentita)
   {
   if(timer_attesa_tensione==0)
    {
    relais_alimentazione=0;
  ...
  else if((dissimmetria>dissimmetria_emergenza)&&(set.monofase_trifase))
   {
   if(timer_attesa_tensione==0)
    {
    relais_alimentazione=0;
   ...
   {
   timer_attesa_tensione=(unsigned char)set.timeout_protezione_tensione;
   if((squilibrio>squilibrio_emergenza)&&(set.monofase_trifase))
    {
    ...
    if(temperatura>set.limite_intervento_temper_motore)
     ...
     &&(potenza_media<potenza_mandata_chiusa)&&(pressione>set.pressione_spegnimento))//soglia di 3/10 di Bar
      {
      ...
      {
      timer_mandata_chiusa=(unsigned char)set.ritardo_stop_mandata_chiusa;
      if(potenza_media<potenza_a_secco)
       {
 ...
 if(segnalazione_<20)
      ...
      if((squilibrio>squilibrio_tollerato)&&(set.monofase_trifase)) segnalazione_=17;
       ...
       if(tensione_media>sovratensione_consentita) segnalazione_=11;
        ...
        if(tensione_media<sottotensione_consentita) segnalazione_=12;
         ...
         if((set.abilita_sensore_pressione)
         &&(set.modo_start_stop==0)
         &&(potenza_media<potenza_mandata_chiusa)&&(pressione>set.pressione_spegnimento)) segnalazione_=13;//soglia di 3/10 di Bar
         else
          {
  ...
  if((segnalazione_>1)&&(prima_segnalazione==0))
   ...
   timer_attesa_segnalazione_fault=3000;
