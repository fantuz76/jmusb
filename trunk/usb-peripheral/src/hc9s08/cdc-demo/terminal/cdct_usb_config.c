...
#define USB_PRODUCT_ID  0x4u
#define USB_DEVICE_REL_NUM  0x00
...
/*
Per il discorso serial NUMBER
http://www.lvr.com/usb_virtual_com_port.htm
Riguarda il penultimo numero nell'array seguente
0=nessun serial number (COM dipende dall'USB usata)
