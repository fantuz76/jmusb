...
//0xc0,0xc1,0xc2,0xc3,0xc4,0xc5,0xc6,0xc7,0xc8,0xc9,0xca,0xcb,0xcc,0xcd,0xce,0xcf,0,
//0xd0,0xd1,0xd2,0xd3,0xd4,0xd5,0xd6,0xd7,0xd8,0xd9,0xda,0xdb,0xdc,0xdd,0xde,0xdf,0},
...
menu_principale[2][86][17]={//Menu' principale: elenco delle funzioni di taratura
"1) Number       ",//0 italiano
"Password:       ",
"2)Single/Three  ",//1
"                ",
...
"               s",
"33)Range sensor ",//32
'T','e','m','p','e','r',':',' ',' ',' ',' ','m','V','/',0xcd,'C',0,
"34)Ambient      ",//33
'T','e','m','p','e','r','a','t','u','r','e',' ',' ',' ',0xcd,'C',0,
"35)Stop Limit   ",//34
'T','e','m','p','e','r','a','t','u','r','e',' ',' ',' ',0xcd,'C',0,
"Italic/Italiano ",//35
"English/Inglese ",
...
0x41, //corrente I2
0x42, //tensione V31
0x46, //temperatura motore
0x42, //tensione V31
0x41, //corrente I2
0x47, //tensione alimentazione elettronica
0x43, //tensione V32
0x40}, //corrente I1
filtro_pulsanti=21,
...
const long
primo_indirizzo_funzioni=0x1fa0000,//506*256 * 256,
indirizzo_conta_ore=0x1fa5000,//(506*256+80) x 256,//salva motore_on, numero_segnalazione, conta_ore conta_ore_funzionamento energia
ultimo_indirizzo_funzioni=0x1fa6400;//(506*256+100) * 256;
...
dati_di_fabbrica[4][50]={
//0=trifase 5.5KW,
1,    //0  numero_serie,
1,    //1  monofase_trifase, 0=monofase, 1=trifase
550,  //2  potenza_nominale, W*10
400,  //3  tensione_nominale, V
137,  //4  corrente_nominale A*10
115,  //5  limite_sovratensione %
80,   //6  limite_sottotensione %
85,   //7  tensione_restart %
12,   //8  limite_segnalazione_dissimmetria %
15,   //9  limite_intervento_dissimmetria %
120,  //10 timeout_protezione_tensione s
115,  //11 limite_sovracorrente %
12,   //12 limite_segnalazione_squilibrio %
15,   //13 limite_intervento_squilibrio %
10,   //14 ritardo_protezione_squilibrio s
300,  //15 limite_corrente_differenziale,//mA
30,   //16 ritardo_intervento_differenziale,//ms
0,    //17 abilita_sensore_pressione
120,  //18 pressione_emergenza Bar*10
50,   //19 pressione_spegnimento BAR*10
30,   //20 pressione_accensione BAR*10
2,    //21 ritardo_funzionamento_dopo_emergenza,//min
70,   //22 potenza_minima_mandata_chiusa %
20,   //23 ritardo_stop_mandata_chiusa //s
10,   //24 ritardo_riaccensione_mandata_chiusa //s
50,   //25 potenza_minima_funz_secco %
40,   //26 ritardo_stop_funzionemento_a_secco //s
2,    //27 ritardo_riaccensione_funzionamento_a_secco //min
160,  //28 portata_sensore_pressione BAR*10
0,    //29 modo_start_stop,//0=remoto o 1=pressione
100,  //30 scala_corrente_differenziale  mA in /mA out
60,   //31 costante_tau_salita_temperatura s
100,  //32 scala_temperatura_motore,//mV/°C
20,   //33 taratura_temperatura_ambiente °C //
100,  //34 limite_intervento_temper_motore,//°C //35
1,    //35 lingua //0=italiano, 1=inglese
...
1,    //0  numero_serie,
1,    //1  monofase_trifase, 0=monofase, 1=trifase
220,  //2  potenza_nominale, W*10
400,  //3  tensione_nominale, V
56,   //4  corrente_nominale A*10
115,  //5  limite_sovratensione %
80,   //6  limite_sottotensione %
85,   //7  tensione_restart %
12,   //8  limite_segnalazione_dissimmetria %
...
//2=monofase 2.2KW,
1,    //0  numero_serie,
0,    //1  monofase_trifase, 0=monofase, 1=trifase
220,  //2  potenza_nominale, W*10
230,  //3  tensione_nominale, V
150,  //4  corrente_nominale A*10
115,  //5  limite_sovratensione %
80,   //6  limite_sottotensione %
85,   //7  tensione_restart %
12,   //8  limite_segnalazione_dissimmetria %
...
limiti_inferiori[4][50]={
//0=trifase 5.5KW,
1,    //0  numero_serie,
1,    //1  monofase_trifase, 0=monofase, 1=trifase
300,  //2  potenza_nominale, W*10
220,  //3  tensione_nominale, V
50,   //4  corrente_nominale A*10
100,  //5  limite_sovratensione %
60,   //6  limite_sottotensione %
60,   //7  tensione_restart %
5,    //8  limite_segnalazione_dissimmetria %
5,    //9  limite_intervento_dissimmetria %
2,    //10 timeout_protezione_tensione s
105,  //11 limite_sovracorrente %
5,    //12 limite_segnalazione_squilibrio %
5,    //13 limite_intervento_squilibrio %
1,    //14 ritardo_protezione_squilibrio s
10,   //15 limite_corrente_differenziale,//mA
20,   //16 ritardo_intervento_differenziale,//ms
0,    //17 abilita_sensore_pressione
40,   //18 pressione_emergenza Bar*10
10,   //19 pressione_spegnimento BAR*10
5,    //20 pressione_accensione BAR*10
1,    //21 ritardo_funzionamento_dopo_emergenza,//min
10,   //22 potenza_minima_mandata_chiusa %
5,    //23 ritardo_stop_mandata_chiusa //s
3,    //24 ritardo_riaccensione_mandata_chiusa //s
10,   //25 potenza_minima_funz_secco %
5,    //26 ritardo_stop_funzionemento_a_secco //s
1,    //27 ritardo_riaccensione_funzionamento_a_secco //min
40,   //28 portata_sensore_pressione BAR*10
0,    //29 modo_start_stop,//0=remoto o 1=pressione
1,    //30 scala_corrente_differenziale  mA in /mA out
10,   //31 costante_tau_salita_temperatura s
2,    //32 scala_temperatura_motore,//mV/°C
5,    //33 taratura_temperatura_ambiente °C //
70,   //34 limite_intervento_temper_motore,//°C //35
0,    //35 lingua //0=italiano, 1=inglese
...
1,    //0  numero_serie,
1,    //1  monofase_trifase, 0=monofase, 1=trifase
75,   //2  potenza_nominale, W*10
220,  //3  tensione_nominale, V
10,   //4  corrente_nominale A*10
100,  //5  limite_sovratensione %
60,   //6  limite_sottotensione %
60,   //7  tensione_restart %
5,    //8  limite_segnalazione_dissimmetria %
...
1,    //0  numero_serie,
0,    //1  monofase_trifase, 0=monofase, 1=trifase
37,   //2  potenza_nominale, W*10
110,  //3  tensione_nominale, V
50,   //4  corrente_nominale A*10
100,  //5  limite_sovratensione %
60,   //6  limite_sottotensione %
60,   //7  tensione_restart %
...
limiti_superiori[4][50]={
//0=trifase 5.5KW,
65535,//0  numero_serie,
1,    //1  monofase_trifase, 0=monofase, 1=trifase
550,  //2  potenza_nominale, W*10
440,  //3  tensione_nominale, V
160,  //4  corrente_nominale A*10
125,  //5  limite_sovratensione %
95,   //6  limite_sottotensione %
100,  //7  tensione_restart %
20,   //8  limite_segnalazione_dissimmetria %
25,   //9  limite_intervento_dissimmetria %
160,  //10 timeout_protezione_tensione s
140,  //11 limite_sovracorrente %
20,   //12 limite_segnalazione_squilibrio %
25,   //13 limite_intervento_squilibrio %
120,  //14 ritardo_protezione_squilibrio s
500,  //15 limite_corrente_differenziale,//mA
200,  //16 ritardo_intervento_differenziale,//ms
1,    //17 abilita_sensore_pressione
450,  //18 pressione_emergenza Bar*10
400,  //19 pressione_spegnimento BAR*10
400,  //20 pressione_accensione BAR*10
999,  //21 ritardo_funzionamento_dopo_emergenza,//min
100,  //22 potenza_minima_mandata_chiusa %
120,  //23 ritardo_stop_mandata_chiusa //s
999,  //24 ritardo_riaccensione_mandata_chiusa //s
100,  //25 potenza_minima_funz_secco %
120,  //26 ritardo_stop_funzionemento_a_secco //s
999,  //27 ritardo_riaccensione_funzionamento_a_secco //min
500,  //28 portata_sensore_pressione BAR*10
1,    //29 modo_start_stop,//0=remoto o 1=pressione
250,  //30 scala_corrente_differenziale  mA in /mA out
180,  //31 costante_tau_salita_temperatura s
250,  //32 scala_temperatura_motore,//mV/°C
40,   //33 taratura_temperatura_ambiente °C //
150,  //34 limite_intervento_temper_motore,//°C //35
1,    //35 lingua //0=italiano, 1=inglese
...
monofase_trifase,// 0=monofase, 1=trifase
...
taratura_temperatura_ambiente,// °C
limite_intervento_temper_motore,//°C //35
lingua, //0=italiano, 1=inglese
...
energia[2],//KWh
motore_on,//0-1=avviamento normale, 2=misura energia
riserva[2];
}set;
...
display[34],
cifre[16], 
buffer_USB[100],//contiene i 24 bytes degli errori
cursore_menu,
comando_display;
...
__interrupt void timer1_overflowISR(void) //timer 100 us per relay periodo=1200
{
asm
 {
...
calcolo_PWM:
// PWM_relay = 1200*alimentazione12V/DAC.tensione_15V
 LDA #17
 STA j
ripetizione:
 LDA numeratore:1
...
;pressione=(DAC.sensore_pressione-491)*set.portata_sensore_pressione/fattore_portata;
 ...
 case 16:
  ...
  if((set.monofase_trifase)&&(relay_alimentazione)) cosfi[0]=calcolo_del_fattore_di_potenza(attiva,reattiva); else cosfi[0]=0;//cosfi*100
 ...
 case 17:
  ...
  if((set.monofase_trifase)&&(relay_alimentazione)) cosfi[1]=calcolo_del_fattore_di_potenza(attiva,reattiva); else cosfi[1]=0;//cosfi*100
 ...
 case 18:
  ...
  if((set.monofase_trifase)&&(relay_alimentazione)) cosfi[2]=calcolo_del_fattore_di_potenza(attiva,reattiva); else cosfi[2]=0;//cosfi*100
...
;  {
;  if(reset_default) dato_scritto=0xff;
;  else dato_scritto=buffer_eeprom[indirizzo_buffer_eeprom+conta_dati_scrittura_eeprom];
;  conta_dati_scrittura_eeprom++;
;  }
...
;  }
 ...
 LDHX #0
 STHX conta_dati_scrittura_eeprom
 LDA #$06
...
parte_alta_dato: 
 LDHX conta_dati_scrittura_eeprom
 CPHX lunghezza_salvataggio
...
;  }
 LDA reset_default
 BNE per_conta_dati_scrittura
 LDA indirizzo_buffer_eeprom:1
 ADD conta_dati_scrittura_eeprom:1
 STA indirizzo:1
 LDA indirizzo_buffer_eeprom
 ADC conta_dati_scrittura_eeprom
 STA indirizzo
 LDHX indirizzo
 LDA @buffer_eeprom,X
 STA dato_scritto//_SPID
per_conta_dati_scrittura:
 LDA conta_dati_scrittura_eeprom:1
 ADD #1
 STA conta_dati_scrittura_eeprom:1
...
const int mille678=1678, mille515=1515, seicento=600;
void calcolo_delle_costanti(void)
{
char j;
int quad_In;
...
//timer_ritorno_da_emergenza=set.ritardo_riaccensione_dopo_emergenza*60;
 ...
 LDA set.ritardo_funzionamento_dopo_emergenza
 LDX #60
 MUL
 STA timer_ritorno_da_emergenza
...
if(salita_func)
 ...
 if(toggle_func==0)
  ...
  presenta_menu((unsigned char*)&menu_principale,(char)set.lingua,tot_righe_menu,cursore_menu<<1);
  }
 }
...
if(toggle_func)//lettura e modifica delle funzioni
 ...
 if(salita_enter)
  {
  salita_enter=0;
  if(cursore_menu==36) //presentazione dell'elenco emergenze
   {
   toggle_enter=1;
   if(allarme_in_lettura>=totale_indicazioni_fault) allarme_in_lettura=0; else allarme_in_lettura++;
   } 
  else if((cursore_menu==40)||(cursore_menu==41)||(cursore_menu==42))
   {
   if(toggle_enter) toggle_enter=0; else toggle_enter=1;
   toggle_start=1;
   salita_start=0;
   ...
   if((relay_alimentazione==0)&&(remoto==filtro_pulsanti))
    ...
    timer_attesa_differenziale=set.ritardo_intervento_differenziale;
    tentativi_avviamento=N_tentativi_motore_bloccato;
    }
   } 
  else if(toggle_enter) toggle_enter=0; else toggle_enter=1;
  } 
 
 if(toggle_enter==0)//modifica della funzione
  {
  if(salita_meno)
   {
   salita_meno=0;
   if(numero_ingresso==chiave_ingresso)
    {
    if(cursore_menu<36) cursore_menu++; else cursore_menu=1;
    } 
   else if(numero_ingresso==chiave_numero_serie)
    {
    if(cursore_menu<42) cursore_menu++; else cursore_menu=1;
    } 
   else// nessuna chiave
    {
    if(cursore_menu==37) cursore_menu=0;
    else if(cursore_menu<4) cursore_menu++;
    else cursore_menu=37;
    }
   ...
   if(numero_ingresso==chiave_ingresso)
    {
    if(cursore_menu>1) cursore_menu--; else cursore_menu=36;
    } 
   else if(numero_ingresso==chiave_numero_serie)
    {
    if(cursore_menu>1) cursore_menu--; else cursore_menu=42;
    } 
   else// nessuna chiave
    {
    if(cursore_menu==37) cursore_menu=4;
    else if(cursore_menu>0) cursore_menu--;
    else cursore_menu=37;
    }
   if(set.monofase_trifase==0)
    {
  ...
  switch(cursore_menu)
   ...
   case 0://abilitazione delle funzioni
    {
    if((numero_ingresso==chiave_ingresso)||(numero_ingresso==chiave_numero_serie))
     {
     presenta_scritta((char *)&accesso_password,0,(char)set.lingua,1,0,0,16);
   ...
   case 21: presenta_unsigned(set.ritardo_funzionamento_dopo_emergenza,0,1,10,3); break;
   ...
   case 27: presenta_unsigned(set.ritardo_riaccensione_funzionamento_a_secco,0,1,10,3); break;
   case 28: presenta_unsigned(set.portata_sensore_pressione,1,1,10,3); break;
   case 29:
    {
   ...
   case 30: presenta_unsigned(set.scala_corrente_differenziale,0,1,7,3); break;
   case 31: presenta_unsigned(set.costante_tau_salita_temperatura,0,1,10,3); break;
   case 32: presenta_unsigned(set.scala_temperatura_motore,0,1,8,3); break;
   case 33: presenta_unsigned(set.taratura_temperatura_ambiente,0,1,11,3); break;
   case 34: presenta_unsigned(set.limite_intervento_temper_motore,0,1,11,3); break;
 //case 35: presenta_menu((unsigned char*)&presenta_lingua,(char)set.lingua,2,0); break;
 //case 36: storico allarmi
   case 37:
    {
    if(timer_aggiorna_misure==0)
     {
     ...
     presenta_energia(KWh,3,0,7,8);
     }
    } break;
   case 38: presenta_unsigned(set.numero_serie,0,1,7,5); break;
   case 39: presenta_scritta((char*)&attivazione_comando_reset,1,0,1,1,0,16); break;
   case 40: presenta_unsigned(set.calibrazione_I1,0,0,12,3); break;
   case 41: presenta_unsigned(set.calibrazione_I3,0,0,12,3); break;
   case 42: presenta_unsigned(set.calibrazione_I2,0,0,12,3); break;
   }
  }
 //if(toggle_enter) modifica del valore 
 else
  {
  limite_inf=limiti_inferiori[N_tabella][cursore_menu];
  limite_sup=limiti_superiori[N_tabella][cursore_menu];
  switch(cursore_menu)
   {
   case 0:  //abilitazione delle funzioni
    {
    ...
    presenta_unsigned(numero_ingresso,0,1,10,3);
    timer_aggiorna_misure=1000;
    } break;
   case 1:
    {
    modifica_unsigned((unsigned int*)&set.monofase_trifase,limite_inf,limite_sup,0);
    if(set.monofase_trifase) presenta_scritta((char*)&presenta_monofase_trifase,1,(char)set.lingua,2,1,0,16);
    else presenta_scritta((char*)&presenta_monofase_trifase,0,(char)set.lingua,2,1,0,16);
    } break;
   case 2:
    {
    modifica_unsigned((unsigned int*)&set.potenza_nominale,limite_inf,limite_sup,0);
    presenta_unsigned(set.potenza_nominale,2,1,10,3);
    } break;
   case 3:
    {
    modifica_unsigned((unsigned int*)&set.tensione_nominale,limite_inf,limite_sup,0);
    presenta_unsigned(set.tensione_nominale,0,1,10,3);
    } break;
   case 4:
    {
    modifica_unsigned((unsigned int*)&set.corrente_nominale,limite_inf,limite_sup,0);
    presenta_unsigned(set.corrente_nominale,1,1,10,3);
    } break;
   case 5:
    {
    modifica_unsigned((unsigned int*)&set.limite_sovratensione,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_sovratensione,0,1,10,3);
    } break;
   case 6:
    {
    modifica_unsigned((unsigned int*)&set.limite_sottotensione,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_sottotensione,0,1,10,3);
    } break;
   case 7:
    {
    modifica_unsigned((unsigned int*)&set.tensione_restart,set.limite_sottotensione,limite_sup,0);
    presenta_unsigned(set.tensione_restart,0,1,10,3);
    } break;
   case 8:
    {
    modifica_unsigned((unsigned int*)&set.limite_segnalazione_dissimmetria,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_segnalazione_dissimmetria,0,1,10,3);
    } break;
   case 9:
    {
    modifica_unsigned((unsigned int*)&set.limite_intervento_dissimmetria,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_intervento_dissimmetria,0,1,10,3);
    } break;
   case 10:
    {
    modifica_unsigned((unsigned int*)&set.timeout_protezione_tensione,limite_inf,limite_sup,0);
    presenta_unsigned(set.timeout_protezione_tensione,0,1,12,3);
    } break;
   case 11:
    {
    modifica_unsigned((unsigned int*)&set.limite_sovracorrente,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_sovracorrente,0,1,10,3);
    } break;
   case 12:
    {
    modifica_unsigned((unsigned int*)&set.limite_segnalazione_squilibrio,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_segnalazione_squilibrio,0,1,11,3);
    } break;
   case 13:
    {
    modifica_unsigned((unsigned int*)&set.limite_intervento_squilibrio,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_intervento_squilibrio,0,1,11,3);
    } break;
   case 14:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_protezione_squilibrio,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_protezione_squilibrio,0,1,12,3);
    } break;
   case 15:
    {
    modifica_unsigned((unsigned int*)&set.limite_corrente_differenziale,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_corrente_differenziale,0,1,10,3);
    } break;
   case 16:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_intervento_differenziale,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_intervento_differenziale,0,1,11,3);
    } break;
   case 17:
    {
    modifica_unsigned((unsigned int*)&set.abilita_sensore_pressione,limite_inf,limite_sup,0);
    if(set.abilita_sensore_pressione) presenta_scritta((char*)&lettura_allarmi,2,0,25,1,0,16);
    else presenta_scritta((char*)&lettura_allarmi,1,0,25,1,0,16);
    } break;
   case 18:
    {
    modifica_unsigned((unsigned int*)&set.pressione_emergenza,limite_inf,set.portata_sensore_pressione,0);
    presenta_unsigned(set.pressione_emergenza,1,1,9,3);
    } break;
   case 19:
    {
    modifica_unsigned((unsigned int*)&set.pressione_spegnimento,limite_inf,set.portata_sensore_pressione,0);
    presenta_unsigned(set.pressione_spegnimento,1,1,9,3);
    } break;
   case 20:
    {
    modifica_unsigned((unsigned int*)&set.pressione_accensione,limite_inf,set.pressione_spegnimento,0);
    presenta_unsigned(set.pressione_accensione,1,1,9,3);
    } break;
   case 21:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_funzionamento_dopo_emergenza,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_funzionamento_dopo_emergenza,0,1,10,3);
    } break;
   case 22:
    {
    modifica_unsigned((unsigned int*)&set.potenza_minima_mandata_chiusa,limite_inf,limite_sup,0);
    presenta_unsigned(set.potenza_minima_mandata_chiusa,0,1,10,3);
    } break;
   case 23:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_stop_mandata_chiusa,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_stop_mandata_chiusa,0,1,11,3);
    } break;
   case 24:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_riaccensione_mandata_chiusa,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_riaccensione_mandata_chiusa,0,1,11,3);
    } break;
   case 25:
    {
    modifica_unsigned((unsigned int*)&set.potenza_minima_funz_secco,limite_inf,limite_sup,0);
    presenta_unsigned(set.potenza_minima_funz_secco,0,1,10,3);
    } break;
   case 26:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_stop_funzionemento_a_secco,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_stop_funzionemento_a_secco,0,1,11,3);
    } break;
   case 27:
    {
    modifica_unsigned((unsigned int*)&set.ritardo_riaccensione_funzionamento_a_secco,limite_inf,limite_sup,0);
    presenta_unsigned(set.ritardo_riaccensione_funzionamento_a_secco,0,1,10,3);
    } break;
   case 28:
    {
    modifica_unsigned((unsigned int*)&set.portata_sensore_pressione,limite_inf,limite_sup,0);
    presenta_unsigned(set.portata_sensore_pressione,1,1,10,3);
    } break;
   case 29:
    {
    modifica_unsigned((unsigned int*)&set.modo_start_stop,limite_inf,limite_sup,0);
   ...
   case 30:
    {
    modifica_unsigned((unsigned int*)&set.scala_corrente_differenziale,limite_inf,limite_sup,0);
    presenta_unsigned(set.scala_corrente_differenziale,0,1,7,3);
    } break;
   case 31:
    {
    modifica_unsigned((unsigned int*)&set.costante_tau_salita_temperatura,limite_inf,limite_sup,0);
    presenta_unsigned(set.costante_tau_salita_temperatura,0,1,10,3);
    } break;
   case 32:
    {
    modifica_unsigned((unsigned int*)&set.scala_temperatura_motore,limite_inf,limite_sup,0);
    presenta_unsigned(set.scala_temperatura_motore,0,1,8,3);
    } break;
   case 33:
    {
    modifica_unsigned((unsigned int*)&set.taratura_temperatura_ambiente,limite_inf,limite_sup,0);
    if(salita_piu | salita_meno) set.temperatura_ambiente=DAC.temperatura_letta;
    presenta_unsigned(set.taratura_temperatura_ambiente,0,1,11,3);
    } break;
   case 34:
    {
    modifica_unsigned((unsigned int*)&set.limite_intervento_temper_motore,limite_inf,limite_sup,0);
    presenta_unsigned(set.limite_intervento_temper_motore,0,1,11,3);
    } break;
   case 35:
    {
    modifica_unsigned((unsigned int*)&set.lingua,limite_inf,limite_sup,0);
    presenta_menu((unsigned char*)&presenta_lingua,(char)set.lingua,2,0);
    } break;
   case 36:
    {
    if(pronto_alla_risposta)
     ...
     if(buffer_USB[0]<limite_segnalazioni)
      {  
      asm
       {
       LDHX buffer_USB:1
      ...
      {  
      presenta_scritta((unsigned char *)&linea_tratteggiata,0,0,0,1,0,16);
      }
     }
    } break;
   case 37://misura dell'energia
    {
   ...
   case 39: //reset
    ...
    if(meno==filtro_pulsanti)
     {
     presenta_scritta((char*)&attivazione_comando_reset,0,0,1,1,0,9);
     ...
     timer_reset=5;//5 s attesa reset
     comando_reset=0;
     presenta_scritta((char*)&attivazione_comando_reset,1,0,1,1,0,16);
     }
    } break;
   case 40:
    {
    modifica_unsigned((unsigned int*)&set.calibrazione_I1,limite_inf,limite_sup,0);
   ...
   case 41:
    {
    modifica_unsigned((unsigned int*)&set.calibrazione_I3,limite_inf,limite_sup,0);
   ...
   case 42:
    {
    modifica_unsigned((unsigned int*)&set.calibrazione_I2,limite_inf,limite_sup,0);
  ...
  if(timer_aggiorna_misure==0)
   ...
   if(set.monofase_trifase==0) //con alimentazione monofase
    ...
    if(alternanza_presentazione==0x80)
     ...
     display[31]='S';
     if(sequenza_fasi) display[32]='1'; else display[32]='0';
     } 
    }
   } 
  }
 else if((reset_default)||(eeprom_impegnata))
  {
     ...
     &&(potenza_media<potenza_mandata_chiusa)&&(pressione>set.pressione_spegnimento))//mandata chiusa
      ...
      if(potenza_media<potenza_a_secco) //funzionamento a secco
       ...
       if(timer_attesa_secco==0)
        ...
        relay_alimentazione=0;
        segnalazione_=24;
        timer_riavviamento=timer_ritorno_da_emergenza_funzionamento_a_secco;
        }
       } 
